% [x_reconstructed, tx] = sound_reconstruction(stft, f, t, fs, window, overlap, my_tracks,f_limit)
%
...
%
% THE STFT IS NOT COMPUTED IN THIS FUNCTION. IF THIS IS DESIRED
% CHECK THE FUNCTOION "sound_reconstruction_stft.m".
%
...
% signal, hence the phase and is an input parameter of this function.
% 
...
%
% INPUTS
%   - stft, short time Fourier transform of the input acoustic signal,
%   - f, stft frequency vector (Hz),
%   - t, stft time vector (s),
%   - fs, sampling frequency of the acoustic signal (Hz),
...
function [x_reconstructed, tx] = sound_reconstruction(stft, f, t, fs, window, overlap, my_tracks,f_limit)
